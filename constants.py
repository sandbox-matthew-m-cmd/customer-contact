...
# 2026/01/05 m.sonoki add start
SEARCH_ALL_INFO_TOOL_NAME = "search_all_info_tool"
SEARCH_ALL_INFO_TOOL_DESCRIPTION = "会社、サービス、顧客情報を含む全てのデータベースから総合的に情報を検索したい時に使う"
CURRENT_DATE_TOOL_NAME = "current_date_tool"
CURRENT_DATE_TOOL_DESCRIPTION = "現在の日付や時刻を取得したい時に使う"
# 2026/01/05 m.sonoki add end
...
#         - 【問い合わせ情報】の「日時」
#         - 【回答・対応案とその根拠】
#         - 【メンション先の選定理由】（メンションしたメンバーが適任である根拠を、問い合わせ内容と従業員情報・過去履歴に紐づけて具体的に記載する）
